pipeline {
    ...
    stages{
        ...
        stage('Deploy to Artifactory') {
            steps {
                script {
                    sh "curl -X PUT -u ${ART_USER}:${ART_PASS} -T bank-microservice/target/*.jar 'http://ec2-50-18-84-74.us-west-1.compute.amazonaws.com:8081/artifactory/${ART_MAVEN_REPO}/aline-bank.jar'"
                }
            }
        }
    }
